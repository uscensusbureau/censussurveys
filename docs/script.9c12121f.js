...
var e=require("airtable"),r=new e({apiKey:"keyWfSmHAolRQJxTk"}).base("appAzdZwdzJzHt494");function t(e){return e=(e=e.replace("Other Geos","Other")).replace("Other Freqs","Other")}r("Surveys").select({view:"Developer",fields:["Survey","Description","Link","Frequency","Geography","Subtopics","Topic"]}).eachPage(function(e,r){function i(e,r){recordText=r.get(e);var i=recordText.join(", "),s=recordText.map(function(e){return e.replace(/\s/g,"").replace("/","")}).join(" ").toLowerCase();return[t(i),s]}e.forEach(function(e){title=e.get("Survey"),link=e.get("Link"),text=e.get("Description");var r=text.length>250&&text.substring(0,250)+"<a href=".concat(link,">...more</a>")||text;frequencies=i("Frequency",e),geos=i("Geography",e),topics=i("Topic",e),subtopics=i("Subtopics",e);var t=subtopics[0].length>50&&subtopics[0].substring(0,50)+"<a href=".concat(link,">...more</a>")||subtopics[0],s=$("<div/>",{class:"card mb-3 "+frequencies[1]+" "+geos[1]+" "+subtopics[1]+" "+topics[1]+" "}),c=$("<div/>",{class:"card-body"}),o=$("<ul/>",{class:"list-group list-group-flush"});c.append("<h5 class='card-title'><a target='_blank' href="+link+">"+title+" →</a></h5>"),c.append("<p class='card-text'>"+r+"</p>"),s.append(c),s.append(o),o.append("<li class='list-group-item'><b>Frequencies: </b>"+frequencies[0]+"&nbsp;</li>"),o.append("<li class='list-group-item'><b>Geographies: </b>"+geos[0]+"&nbsp;</li>"),o.append("<li class='list-group-item'><b>Topics: </b>"+topics[0]+"&nbsp;</li>"),o.append("<li class='list-group-item'><b>Subtopics: </b>"+t+"&nbsp;</li>");var p=$("<div/>",{class:"col"});p.append(s),$("#cards").append(p)}),r()},function(e){e&&console.error(e)}),r("Filters").select({view:"Topics",fields:["Filter","Type","Publish?"]}).eachPage(function(e,r){e.forEach(function(e){if(recordText=e.get("Filter"),recordText){recordType=e.get("Type"),publish=e.get("Publish?");var r="<li><input type='checkbox' id="+recordText.replace(/\s/g,"").replace("/","").toLowerCase()+" value='"+recordText+"' title="+recordText+" class='filterCheckbox' /> "+recordText+"</li>";"Yes"==publish&&("Subtopics"==recordType&&$("#subtopicsFilters").append(r),"Topics"==recordType&&$("#topicFilters").append(r))}}),r()},function(e){e&&console.error(e)}),r("Filters").select({view:"Geos & Freqs",fields:["Filter","Type","Publish?"]}).eachPage(function(e,r){e.forEach(function(e){if(recordText=e.get("Filter"),recordText){recordType=e.get("Type"),publish=e.get("Publish?");var r="<li><input type='checkbox' id="+recordText.replace(/\s/g,"").replace("/","").toLowerCase()+" value='"+t(recordText)+"' title="+t(recordText)+" class='filterCheckbox' /> "+t(recordText)+"</li>";"Yes"==publish&&("Geographies"==recordType&&$("#geographyFilters").append(r),"Frequencies"==recordType&&$("#frequencyFilters").append(r))}}),r()},function(e){e&&console.error(e)});
