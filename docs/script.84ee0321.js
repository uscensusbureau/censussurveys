...
},{"./_baseGetTag":"fkTb","./_getPrototype":"q4qA","./isObjectLike":"cwaR"}],"cIZe":[function(require,module,exports) {
...
},{"node-fetch":"cIZe"}],"UbQd":[function(require,module,exports) {
...
},{"abort-controller":"cIZe","abortcontroller-polyfill/dist/cjs-ponyfill":"UbQd"}],"bWel":[function(require,module,exports) {
...
var e=require("airtable"),t=new e({apiKey:"keyWfSmHAolRQJxTk"}).base("appAzdZwdzJzHt494");function o(e){return e=(e=e.replace("Other Geos","Other")).replace("Other Freqs","Other")}var i=function(e,t,o){return'\n<div class="modal fade" id="'.concat(o,'" tabindex="-1" role="dialog">\n    <div class="modal-dialog" role="document">\n      <div class="modal-content">\n        <div class="modal-header">\n          <h5 class="modal-title" id="exampleModalLabel">').concat(e,'</h5>\n          <button type="button" class="close" data-dismiss="modal" aria-label="Close">\n            <span aria-hidden="true">&times;</span>\n          </button>\n        </div>\n        <div class="modal-body">\n          ').concat(t,'\n        </div>\n        <div class="modal-footer">\n          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>\n        </div>\n      </div>\n    </div>\n    </div>\n')};t("Surveys").select({view:"Developer",fields:["Survey","Description","Link","Frequency","Geography","Subtopics","Topic"]}).eachPage(function(e,t){function s(e,t){recordText=t.get(e);var i=recordText.join(", "),s=recordText.map(function(e){return e.replace(/\s/g,"").replace("/","")}).join(" ").toLowerCase();return[o(i),s]}e.forEach(function(e,t){title=e.get("Survey"),link=e.get("Link"),text=e.get("Description");var o=text.length>250&&text.substring(0,250)+'<button class="modal-button" data-toggle="modal" data-target="#description'.concat(t,'">...more</button>')||text;frequencies=s("Frequency",e),geos=s("Geography",e),topics=s("Topic",e),subtopics=s("Subtopics",e);var r=subtopics[0].length>50&&subtopics[0].substring(0,50)+'<button class="modal-button" data-toggle="modal" data-target="#subtopics'.concat(t,'">...more</button>')||subtopics[0],c=i(title+" Subtopics",subtopics[0],"subtopics".concat(t)),a=i(title+" Description",text,"description".concat(t)),n=$("<div/>",{class:"col card mb-3 "+frequencies[1]+" "+geos[1]+" "+subtopics[1]+" "+topics[1]+" "}),l=$("<div/>",{class:"card-body"}),p=$("<ul/>",{class:"list-group"});l.append("<h5 class='card-title'><a target='_blank' href="+link+">"+title+" →</a></h5>"),l.append("<p class='card-text'>"+o+"</p>"),n.append(l).append(c).append(a),n.append(p),p.append("<li class='list-group-item'><b>Frequencies: </b>"+frequencies[0]+"&nbsp;</li>"),p.append("<li class='list-group-item'><b>Geographies: </b>"+geos[0]+"&nbsp;</li>"),p.append("<li class='list-group-item'><b>Topics: </b>"+topics[0]+"&nbsp;</li>"),p.append("<li class='list-group-item'><b>Subtopics: </b>"+r+"&nbsp;</li>"),$("#cards").append(n)}),t()},function(e){e&&console.error(e)}),t("Filters").select({view:"Topics",fields:["Filter","Type","Publish?"]}).eachPage(function(e,t){e.forEach(function(e){if(recordText=e.get("Filter"),recordText){recordType=e.get("Type"),publish=e.get("Publish?");var t="<li><input type='checkbox' id="+recordText.replace(/\s/g,"").replace("/","").toLowerCase()+" value='"+recordText+"' title="+recordText+" class='filterCheckbox' /> "+recordText+"</li>";"Yes"==publish&&("Subtopics"==recordType&&$("#subtopicsFilters").append(t),"Topics"==recordType&&$("#topicFilters").append(t))}}),t()},function(e){e&&console.error(e)}),t("Filters").select({view:"Geos & Freqs",fields:["Filter","Type","Publish?"]}).eachPage(function(e,t){e.forEach(function(e){if(recordText=e.get("Filter"),recordText){recordType=e.get("Type"),publish=e.get("Publish?");var t="<li><input type='checkbox' id="+recordText.replace(/\s/g,"").replace("/","").toLowerCase()+" value='"+o(recordText)+"' title="+o(recordText)+" class='filterCheckbox' /> "+o(recordText)+"</li>";"Yes"==publish&&("Geographies"==recordType&&$("#geographyFilters").append(t),"Frequencies"==recordType&&$("#frequencyFilters").append(t))}}),t()},function(e){e&&console.error(e)});
