...
},{"./_baseGetTag":"fkTb","./_getPrototype":"q4qA","./isObjectLike":"cwaR"}],"cY7S":[function(require,module,exports) {
...
},{"node-fetch":"cY7S"}],"UbQd":[function(require,module,exports) {
...
},{"abort-controller":"cY7S","abortcontroller-polyfill/dist/cjs-ponyfill":"UbQd"}],"bWel":[function(require,module,exports) {
...
var e=require("airtable"),r=new e({apiKey:"keyWfSmHAolRQJxTk"}).base("appAzdZwdzJzHt494");function i(e){return e=(e=e.replace("Other Geos","Other")).replace("Other Freqs","Other")}r("Surveys").select({view:"Developer",fields:["Survey","Description","Link","Frequency","Geography","Subtopics","Topic"]}).eachPage(function(e,r){function t(e,r){recordText=r.get(e);var t=recordText.join(", "),s=recordText.map(function(e){return e.replace(/\s/g,"")}).join(" ").replace("/","").toLowerCase();return[i(t),s]}e.forEach(function(e){title=e.get("Survey"),link=e.get("Link"),text=e.get("Description"),frequencies=t("Frequency",e),geos=t("Geography",e),topics=t("Topic",e),subtopics=t("Subtopics",e);var r=$("<div/>",{class:"card mb-3 "+frequencies[1]+" "+geos[1]+" "+subtopics[1]+" "+topics[1]+" "}),i=$("<div/>",{class:"card-body"}),s=$("<ul/>",{class:"list-group list-group-flush"});i.append("<h5 class='card-title'><a target='_blank' href="+link+">"+title+" →</a></h5>"),i.append("<p class='card-text'>"+text+"</p>"),r.append(i),r.append(s),s.append("<li class='list-group-item'><b>Frequencies: </b>"+frequencies[0]+"&nbsp;</li>"),s.append("<li class='list-group-item'><b>Geographies: </b>"+geos[0]+"&nbsp;</li>"),s.append("<li class='list-group-item'><b>Topics: </b>"+topics[0]+"&nbsp;</li>"),s.append("<li class='list-group-item'><b>Subtopics: </b>"+subtopics[0]+"&nbsp;</li>"),$("#cards").append(r)}),r()},function(e){e&&console.error(e)}),r("Filters").select({view:"Topics",fields:["Filter","Type","Publish?"]}).eachPage(function(e,r){e.forEach(function(e){recordText=e.get("Filter"),recordType=e.get("Type"),publish=e.get("Publish?");var r="<li><input type='checkbox' id="+recordText.replace(/\s/g,"").replace("/","").toLowerCase()+" value='"+recordText+"' title="+recordText+" class='filterCheckbox' /> "+recordText+"</li>";"Yes"==publish&&("Subtopics"==recordType&&$("#subtopicsFilters").append(r),"Topics"==recordType&&$("#topicFilters").append(r))}),r()},function(e){e&&console.error(e)}),r("Filters").select({view:"Geos & Freqs",fields:["Filter","Type","Publish?"]}).eachPage(function(e,r){e.forEach(function(e){recordText=e.get("Filter"),recordType=e.get("Type"),publish=e.get("Publish?");var r="<li><input type='checkbox' id="+recordText.replace(/\s/g,"").replace("/","").toLowerCase()+" value='"+i(recordText)+"' title="+i(recordText)+" class='filterCheckbox' /> "+i(recordText)+"</li>";"Yes"==publish&&("Geographies"==recordType&&$("#geographyFilters").append(r),"Frequencies"==recordType&&$("#frequencyFilters").append(r))}),r()},function(e){e&&console.error(e)});
},{"airtable":"gskY"}]},{},["nq4D"], null)
//# sourceMappingURL=script.04158735.js.map