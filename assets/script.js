    ...
    .eachPage(
       ...
       */
            ...
            function createFilters(category, record) {
                ...
                var filter = recordText.map(str => str.replace(/\s/g, "").replace("/", "")).join(" ").toLowerCase()
            ...
            records.forEach(function(record) {
                ...
                $cardDividers.append(
                    "<li class='list-group-item'>" + "<b>Frequencies: </b>" + frequencies[0] + "&nbsp;</li>"
                )
                ...
                $cardDividers.append(
                    "<li class='list-group-item'>" + "<b>Subtopics: </b>" + subtopics[0] + "&nbsp;</li>"
                )
